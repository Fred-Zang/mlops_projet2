...
GBC_2_vectorizer = pickle.load(open("/airflow/clean_model/vectoriser_GBC_2-sav_DAG","rb"))
...
GBC_2_model = pickle.load(open("/airflow/clean_model/GBC_2-sav_DAG.pickle","rb"))
...
def present_part(choose_do):
	if choose_do == 'Modelisations à la demande':
		...
		if model =='GBC_2':
			...
			ANN = tf.keras.models.load_model(r'/airflow/clean_model/ANN-sav-DAG.h5')  # PAS BIEN NOMMEE #######################################
...
def SVM(corpus):
	...
	# charger le model
	# 🌞🌞🌞@fred: changer le file path 🌞🌞🌞
	SVM_wiki = pickle.load(open('/airflow/clean_model/SVM_sav-DAG.pickle','rb'))
...
def GBC_2(corpus):
	# charger le vecteur
	# 🌞🌞🌞@fred: changer le file path 🌞🌞🌞
	vectorizer = pickle.load(open('/airflow/clean_model/vectoriser_GBC_2-sav_DAG','rb'))
	# charger le model 
	# 🌞🌞🌞@fred: changer le file path 🌞🌞🌞
	GBC_2 = pickle.load(open('/airflow/clean_model/GBC_2-sav_DAG.pickle','rb'))
